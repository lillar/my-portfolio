...
Starting with the industry: clinical research is a branch of healthcare science, focusing on determining the safety and effectiveness of medications, devices and diagnostic products. The aim of a clinical research is to collect evidence to establish a treatment and if all goes according to the plan, to get the marketing approval<sup>1</sup>. And how can they verify their hypotheses? Yes, by studying humans. (Sounds creepy and fascinating at the same time.)
...
**Observational studies** are also called epidemiological studies, are those studies where researchers don’t intervene, but rather observe the natural relationship of factors and outcomes. An example could be a study, comparing the prevalence of obesity across different geographic areas where geography is the factor and obesity is the outcome<sup>2</sup>.  

Both interventional and observational study designs have their strengths and weaknesses, which can affect the credibility of the outcome. If you’d like to read more, I recommend the [publication](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4083571/#:~:text=Observational%20study%20designs%20include%20ecological,crossover%2C%20retrospective%20and%20prospective%20cohorts.&text=Interventional%20studies%20are%20often%20prospective,or%20preventive%20measures%20on%20disease.) of Matthew S. Thiese, who collected several approaches and outlines the pros and cons of each study design. 
...
Now let’s see, what stairs need to be climbed before you’ll find a drug on the shelf<sup>3, 4</sup>:

#### 1. Nonclinical phase

In the nonclinical or pre-clinical phase researchers work on identifying the therapies with the highest probability to be successful. In this phase, they assess the safety of the treatment and establish a foundation for further research<sup>5</sup>. 
...
Now, let’s just focus on the phases of a clinical trial defined by the FDA on [their website](https://www.fda.gov/patients/drug-development-process/step-3-clinical-research) – yes, more phases are coming within this phase:

![Three phases of clinical trials](ct_phases.png "Three phases of clinical trials")<br>
...
Moving forward, people in the following roles are core members of the study team, who are involved in the daily activities of the study: the investigator, study coordinator and research nurse<sup>12</sup>.
...
Resources:
1. [Learn about clinical studies, clinicaltrials.gov](https://clinicaltrials.gov/ct2/about-studies/learn)
2.Thiese, Matthew S.: [Observational and interventional study design types; an overview;](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4083571/#:~:text=Observational%20study%20designs%20include%20ecological,crossover%2C%20retrospective%20and%20prospective%20cohorts.&text=Interventional%20studies%20are%20often%20prospective,or%20preventive%20measures%20on%20disease.) Biochem Med (Zagreb). 2014 Jun; 24(2): 199–210. 
3. [The drug development process, fda.gov](https://www.fda.gov/patients/learn-about-drug-and-device-approvals/drug-development-process)
4. Bere, Nathalie: [How are medicines evaluated at the EMA presentation](https://www.ema.europa.eu/en/documents/presentation/presentation-how-are-medicines-evaluated-ema-nathalie-bere_en.pdf)
5. [Non-clinical development: Basic principles, eupati.eu](https://www.eupati.eu/regulatory-affairs/non-clinical-development-basic-principles/)
6. [Three major items to consider when moving from preclinical to clinical development, inamed-cro.com](https://www.inamed-cro.com/index.php?id=216)
7. [Should Animals Be Used for Scientific or Commercial Testing?, procon.org](https://animal-testing.procon.org/) 
8. [Accutane side-effects, drugwatch.com](https://www.drugwatch.com/accutane/side-effects/)
9. [Accutane lawsuit, drugwatch.com](https://www.drugwatch.com/accutane/lawsuits/)
10. [Accutane Lawsuits: What’s Happening Now?, enjuris.com](https://www.enjuris.com/pharmaceutical-liability/accutane-lawsuits.html)
11. [Biopharmaceutical Research & Development: The Process Behind New Medicines, phrma.org](http://phrma-docs.phrma.org/sites/default/files/pdf/rd_brochure_022307.pdf)
12. [Roles in Clinical Research: The Core Study Team, forteresearch.com](https://forteresearch.com/news/roles-in-clinical-research-the-core-study-team/)
13. Krishnankutty, Binny, Bellary, Shantala , Kumar, Naveen B.R. and Moodahadu, Latha S.: [Data management in clinical research: An overview;](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3326906/) Indian J Pharmacol. 2012 Mar-Apr; 44(2): 168–172. `;export{e as default};